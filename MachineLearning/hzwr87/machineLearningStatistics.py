'''
OpenCV implementations of algorithms, based on code from https://github.com/tobybreckon/python-examples-ml

KFolds based on http://scikit-learn.org/stable/modules/cross_validation.html

Confusion Matrix based on http://scikit-learn.org/stable/auto_examples/model_selection/plot_confusion_matrix.html

Classification report based on http://scikit-learn.org/stable/modules/generated/sklearn.metrics.classification_report.html
'''
import csv
import cv2
import numpy as np
